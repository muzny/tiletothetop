...
!1;expDifficultyStep<MAX_DIFFICULTY&&(expDifficultyStep*=2);incrementDifficulty(expDifficultyStep)});$("#toggle-difficulty").click(function(){$(this).is(":checked")?$("#setting-difficulty").css("background-color","#ddd"):$("#setting-difficulty").css("background-color","white")})}
