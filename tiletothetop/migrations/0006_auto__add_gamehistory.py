...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameHistory'
        db.create_table('tiletothetop_gamehistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('word_difficulties', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256)),
        ))
        db.send_create_signal('tiletothetop', ['GameHistory'])


    def backwards(self, orm):
        # Deleting model 'GameHistory'
        db.delete_table('tiletothetop_gamehistory')
