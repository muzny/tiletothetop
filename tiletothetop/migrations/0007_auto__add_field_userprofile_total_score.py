...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.total_score'
        db.add_column('tiletothetop_userprofile', 'total_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.total_score'
        db.delete_column('tiletothetop_userprofile', 'total_score')
