...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameHistory.ids'
        db.add_column('tiletothetop_gamehistory', 'ids',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='0,0,0,0', max_length=256),
                      keep_default=False)

        # Adding field 'GameHistory.mode'
        db.add_column('tiletothetop_gamehistory', 'mode',
                      self.gf('django.db.models.fields.CharField')(default='random', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameHistory.ids'
        db.delete_column('tiletothetop_gamehistory', 'ids')

        # Deleting field 'GameHistory.mode'
        db.delete_column('tiletothetop_gamehistory', 'mode')
    ...
    models = {
        ...
        'tiletothetop.customword': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'part_of_speech': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'word': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'tiletothetop.gamehistory': {
            'Meta': {'object_name': 'GameHistory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ids': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "'0,0,0,0'", 'max_length': '256'}),
            'mode': ('django.db.models.fields.CharField', [], {'default': "'random'", 'max_length': '10'}),
